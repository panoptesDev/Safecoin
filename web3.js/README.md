...
# Panoptis JavaScript API

This is the Panoptis Javascript API built on the Panoptis [JSON RPC API](https://docs.solana.com/apps/jsonrpc-api)
...
2. Install the latest Panoptis release from https://docs.solana.com/cli/install-solana-cli-tools
...
**Please use `cargo build-bpf` from the latest Panoptis release instead of the information in this section**

The Panoptis BPF SDK is located in the `bpf-sdk/` subdirectory if you installed
