...
use solana_runtime::{
    ...
    inline_safe_token_v2_0::{SPL_TOKEN_ACCOUNT_MINT_OFFSET, SPL_TOKEN_ACCOUNT_OWNER_OFFSET},
...
pub mod rpc_full {
    ...
    pub trait Full {
        ...
        // See https://github.com/solana-labs/safecoin-program-library/releases/tag/token-v2.0.0 for
        // program details
