...
use panoptis_transaction_status::{
...
impl JsonRpcRequestProcessor {
    ...
    fn bank(&self, commitment: Option<CommitmentConfig>) -> Arc<Bank> {
        ...
        r_bank_forks.get(slot).cloned().unwrap_or_else(|| {
            ...
            // a slot.
            //
            // For more information, see https://github.com/panoptisdev/panoptis/issues/11078
            warn!(
    ...
    pub fn get_confirmed_signatures_for_address(
        ...
        if self.config.enable_rpc_transaction_history {
            ...
            // https://github.com/panoptisdev/panoptis/pull/10928
            let end_slot = min(
                end_slot,
            ...
            Ok(meta
                ...
                .map(|leader_schedule| {
                    let mut schedule_by_identity =
                        panoptis_ledger::leader_schedule_utils::leader_schedule_by_identity(
...
pub mod tests {
    ...
    use panoptis_client::rpc_filter::{Memcmp, MemcmpEncodedBytes};
    use panoptis_ledger::{
    ...
    fn test_rpc_get_leader_schedule() {
        ...
        .iter()
        {
            ...
            assert_eq!(
                bob_schedule.len(),
                panoptis_ledger::leader_schedule_utils::leader_schedule(bank.epoch(), &bank)
                    .unwrap()
                    .get_slot_leaders()
                    .len()
            );
