use {
    ...
    panoptis_client::rpc_client::RpcClient,
    panoptis_ledger::{blockstore::create_new_ledger, create_new_tmp_ledger},
        ...
        let ledger_path = match &config.ledger_path {
            ...
            Some(ledger_path) => {
                ...
                let _ = create_new_ledger(
                    ...
                    panoptis_ledger::blockstore_db::AccessType::PrimaryOnly,
                )
                .map_err(|err| {
                    format!(
