...
use lru::LruCache;
use panoptis_ledger::shred::{get_shred_slot_index_type, ShredFetchStats};
...
mod tests {
    use super::*;
    use panoptis_ledger::blockstore::MAX_DATA_SHREDS_PER_SLOT;
    ...
    fn test_data_code_same_index() {
        ...
        let coding = panoptis_ledger::shred::Shredder::generate_coding_shreds(
            &[shred],
