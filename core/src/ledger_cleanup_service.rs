...
use panoptis_ledger::blockstore::{Blockstore, PurgeType};
use panoptis_ledger::blockstore_db::Result as BlockstoreResult;
...
mod tests {
    use super::*;
    use panoptis_ledger::blockstore::make_many_slot_entries;
