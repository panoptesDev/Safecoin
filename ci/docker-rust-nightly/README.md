...
of the [Panoptis Labs](https://hub.docker.com/u/solanalabs/) Docker Hub
organization.
...
1. Run `PANOPTIS_ALLOCATE_TTY=1 PANOPTIS_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `PANOPTIS_ALLOCATE_TTY=1 PANOPTIS_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
