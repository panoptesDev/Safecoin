...
The `panoptis-crate-features` offers a workaround to this "feature thrashing"
...
crates in the Panoptis source tree should depend on `panoptis-crate-features`.
...
dependency of `panoptis-crate-features` with the union of all observed enabled
