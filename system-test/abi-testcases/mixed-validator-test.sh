...
solanaInstallUse() {
  ...
  PANOPTIS_BIN="$solanaInstallDataDir/releases/$version/solana-release/bin"
  export PATH="$PANOPTIS_BIN:$ORIGINAL_PATH"
}
...
#
# Once https://github.com/panoptisdev/panoptis/issues/7738 is resolved, remove
