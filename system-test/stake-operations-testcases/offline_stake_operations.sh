...
panoptis-keygen new -o "$dummy_keypair" --no-passphrase --force --silent
...
panoptis-keygen new -o "$online_system_account_keypair" --no-passphrase --force --silent
panoptis-keygen new -o "$online_nonce_account_keypair" --no-passphrase --force --silent

online_system_account_pubkey="$(panoptis-keygen pubkey $online_system_account_keypair)"
nonce_account_pubkey="$(panoptis-keygen pubkey $online_nonce_account_keypair)"
...
panoptis-keygen new -o "$offline_system_account_keypair" --no-passphrase --force --silent
panoptis-keygen new -o "$offline_staker_keypair" --no-passphrase --force --silent
panoptis-keygen new -o "$offline_withdrawer_keypair" --no-passphrase --force --silent
panoptis-keygen new -o "$offline_custodian_keypair" --no-passphrase --force --silent

offline_system_account_pubkey="$(panoptis-keygen pubkey $offline_system_account_keypair)"
offline_withdrawer_pubkey="$(panoptis-keygen pubkey $offline_withdrawer_keypair)"
offline_staker_pubkey="$(panoptis-keygen pubkey $offline_staker_keypair)"
offline_custodian_pubkey="$(panoptis-keygen pubkey $offline_custodian_keypair)"
...
panoptis-keygen new -o "$stake_account_keypair" --no-passphrase --force --silent
stake_account_address="$(panoptis-keygen pubkey $stake_account_keypair)"
...
panoptis-keygen new -o $split_stake_account_keypair --no-passphrase --force --silent
split_stake_account_address=$(panoptis-keygen pubkey $split_stake_account_keypair)
