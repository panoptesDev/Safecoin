...
this step, you should see the “validator-stake-keypair.json” in your Panoptis
runtime directory.
...
- `getVoteAccounts` This will tell you how much active stake your validator currently has. A % of the validator's stake is activated on an epoch boundary. You can learn more about staking on Panoptis [here](../cluster/stake-delegation-and-rewards.md).
