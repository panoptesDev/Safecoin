...
There is no strict minimum amount of PANO required to run a validator on Panoptis.
...
- See [Installing Panoptis](../cli/install-solana-cli-tools.md) for the current Panoptis software release.
...
CUDA is required to make use of the GPU on your system. The provided Panoptis
