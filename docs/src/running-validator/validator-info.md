...
## Run panoptis validator-info

Run the panoptis CLI to populate a validator info account:
...
3. Add or update your `panoptis validator-info` with your Keybase username. The
