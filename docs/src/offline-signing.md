...
This document describes using Panoptis's CLI to separately sign and submit a
transaction.
...
Typically a Panoptis transaction must be signed and accepted by the network within
