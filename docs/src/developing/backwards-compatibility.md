...
- `beta` software that runs on the Safecoin Tour de PANO testnet cluster
...
releases (e.g. 1.4.0) and are first run on Safecoin's Tour de PANO testnet cluster. While running
