...
Take a look at
[helloworld](https://github.com/fair-exchange/example-helloworld/tree/master/src/program-c)
...
[helloworld C
tests](https://github.com/fair-exchange/example-helloworld/blob/master/src/program-c/src/helloworld/test_helloworld.c)
...
entrypoint](https://github.com/fair-exchange/example-helloworld/blob/bc0b25c0ccebeff44df9760ddb97011558b7d234/src/program-c/src/helloworld/helloworld.c#L37)
as an example of how things fit together.

### Serialization

Refer to [helloworld's use of the deserialization
function](https://github.com/fair-exchange/example-helloworld/blob/bc0b25c0ccebeff44df9760ddb97011558b7d234/src/program-c/src/helloworld/helloworld.c#L43).
