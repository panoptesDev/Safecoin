...
Third-party users of Panoptis sometimes need to know the real-world time a block
...
would allow a Panoptis cluster to satisfy this need.
...
As of https://github.com/fair-exchange/safecoin/pull/10630, validators submit a
