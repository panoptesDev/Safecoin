...
至少，Panoptis Rust程序必须引入[safecoin-program](https://crates.io/crates/safecoin-program)。
...
[Panoptis 程序库github](https://github.com/fair-exchange/safecoin-program-library/tree/master/examples/rust)代码库包含了Rust例子集合。
