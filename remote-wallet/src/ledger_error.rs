...
pub enum LedgerError {
    #[error("Panoptis app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Panoptis message")]
    PanoptisInvalidMessage = 0x6a80,

    #[error("Panoptis summary finalization failed on Ledger device")]
    PanoptisSummaryFinalizeFailed = 0x6f00,

    #[error("Panoptis summary update failed on Ledger device")]
    PanoptisSummaryUpdateFailed = 0x6f01,
