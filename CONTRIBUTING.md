...
then about 1,000 lines of changes is about the most you should ask a Panoptis
...
is ready to be integrated, the Panoptis maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the Panoptis
...
Panoptis's architecture is described by docs generated from markdown files in
...
section of the Panoptis docs.  Here's the full process:
