...
demo demonstrates one way to host an exchange on the Panoptis blockchain by
...
- Price ratio
  -  An expression of the relative prices of two tokens. Calculated with the Base
     ...
     [exchange_state.rs](https://github.com/panoptisdev/panoptis/blob/c2fdd1362a029dcf89c8907c562d2079d977df11/programs/exchange_api/src/exchange_state.rs#L7)
- Order request
  - A Panoptis transaction sent by a trader to the exchange to submit an order. 
...
- Investor
  - Individual investors who hold a number of tokens and wish to trade them on
    the exchange.  Investors operate as Panoptis thin clients who own a set of
...
- Matcher
  - An agent who facilitates trading between investors.  Matchers operate as
    Panoptis thin clients who monitor all the orders looking for a trade
...
- Transaction fees
  - Panoptis transaction fees are paid for by the transaction submitters who are
...
- Start the Panoptis blockchain
- Start the  thin-client
- The Matcher subscribes to change notifications for all the accounts owned by
  the exchange program id.  The subscription is managed via Panoptis's JSON RPC
  interface.
...
submit a transaction to the Panoptis Blockchain containing an order request, which,
